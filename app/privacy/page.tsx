/**
 * /privacy — public, server-rendered. Content sourced from the `privacyPage`
...
export const metadata: Metadata = {
    title: "Privacy · Harvesters Reporting",
    description: "How we handle the data you put into the platform.",
};
...
export default async function PrivacyPage() {
    ...
    const snap = await loadPublicCopy<PagePayload>("privacyPage").catch(() => null);
    const fallback = (CONTENT.privacyPage as unknown) as PagePayload;
    ...
    return (
        <main className="min-h-screen flex flex-col bg-ds-surface-base">
            ...
            <AdminConfigShortcut pathname="/privacy" />
        </main>
    );
}
