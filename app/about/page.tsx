/**
 * /about — public, server-rendered. Content sourced from the `aboutPage`
...
export const metadata: Metadata = {
    ...
    description: "What this platform is, who built it, and why it exists.",
};
...
export default async function AboutPage() {
    ...
    const snap = await loadPublicCopy<AboutPayload>("aboutPage").catch(() => null);
    const fallback = (CONTENT.aboutPage as unknown) as AboutPayload;
    ...
    return (
        <main className="min-h-screen flex flex-col bg-ds-surface-base">
            ...
            <AdminConfigShortcut pathname="/about" />
        </main>
    );
}
