...
import { confirmPrimaryEmail, EmailActionError } from "@/modules/auth/services/emailVerificationService";
...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        const result = await confirmPrimaryEmail(parsed.data.token);
