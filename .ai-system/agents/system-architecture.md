...
| `modules/analytics` | Interactive analytics, configurable UI charts, and export with trend/pie/line toolset  | `modules/analytics/components/AnalyticsPage.tsx`                                          | `lib/utils/exportReports`, `lib/data`  |
