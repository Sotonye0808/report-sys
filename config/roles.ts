...
export const ROLE_CONFIG: Record<UserRole, RoleConfig> = {
    [UserRole.SUPERADMIN]: {
        ...
        canQuickFormFill: false,
        canManageAdminConfig: true,
    ...
    [UserRole.USHER]: {
        role: UserRole.USHER,
        label: CONTENT.users.roles.USHER,
        hierarchyOrder: 10,
        dashboardRoute: APP_ROUTES.quickForm,
        dashboardMode: "quick-form",
        canCreateReports: false,
        canFillReports: false,
        canSubmitReports: false,
        canRequestEdits: false,
